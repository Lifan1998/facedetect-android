...
import com.example.facedetection.data.model.StudentsVO;
 ...
 */
public class StudentsVOContent {

    /**
     * An array of sample (dummy) items.
     */
    public static final List<StudentsVO> ITEMS = new ArrayList<StudentsVO>();
    ...
    private static void addItem(StudentsVO item) {
        ITEMS.add(item);
        ITEM_MAP.put(item.getId()+"", item);
    }

    private static StudentsVO createDummyItem(int position) {
        ...
        return new StudentsVO(position, "202160921 ","李帆", position%2+1, avatar);
    }
